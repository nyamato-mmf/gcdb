...
let Colors_array_countries_population_timeseries = [];
let Color_obj_countries_population_timeseries = {};

// Wait for DOM to be fully loaded
document.addEventListener("DOMContentLoaded", function() {
    // Set up canvas size management
    const canvas = document.getElementById("country-population-timeseries");
    ...
    fetch("./data/color_code.csv")
        ...
        .then(csvText => {
            ...
            Colors_array_countries_population_timeseries = Papa.parse(csvText, { header: true, dynamicTyping: true }).data;
            
            // Convert array into an object for easier lookup
            Color_obj_countries_population_timeseries = Colors_array_countries_population_timeseries.reduce((acc, entry) => {
        ...
        .then(csvText => {
            ...
            const datasets = filteredData.map(entry => ({
                ...
                borderColor: Color_obj_countries_population_timeseries[entry["Country_Code"]] || "gray", // Predefined colour or gray
                fill: false
            }));
            
            // Create the chart
            new Chart("country-population-timeseries", {
                type: "line",
                data: {
